...
export interface ApiBearingBearing extends Struct.CollectionTypeSchema {
  collectionName: 'bearings';
  info: {
    displayName: 'bearings';
    pluralName: 'bearings';
    singularName: 'bearing';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiInfrastructureInfrastructure
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customers: Schema.Attribute.Integer;
    description: Schema.Attribute.Blocks;
    experience: Schema.Attribute.Integer;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    plants: Schema.Attribute.Integer;
    presence: Schema.Attribute.String;
    products: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    warehouses: Schema.Attribute.Integer;
  };
}

export interface ApiManfacturingProcessManfacturingProcess
  extends Struct.CollectionTypeSchema {
  collectionName: 'manfacturing_processes';
  info: {
    displayName: 'manfacturing-process';
    pluralName: 'manfacturing-processes';
    singularName: 'manfacturing-process';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::manfacturing-process.manfacturing-process'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiManufacturingSectionManufacturingSection
  extends Struct.SingleTypeSchema {
  collectionName: 'manufacturing_sections';
  info: {
    displayName: 'manufacturing-section';
    pluralName: 'manufacturing-sections';
    singularName: 'manufacturing-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::manufacturing-section.manufacturing-section'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::bearing.bearing': ApiBearingBearing;
      'api::contact.contact': ApiContactContact;
      'api::footer.footer': ApiFooterFooter;
      'api::hero-section.hero-section': ApiHeroSectionHeroSection;
      'api::infrastructure.infrastructure': ApiInfrastructureInfrastructure;
      'api::manfacturing-process.manfacturing-process': ApiManfacturingProcessManfacturingProcess;
      'api::manufacturing-section.manufacturing-section': ApiManufacturingSectionManufacturingSection;
